...
const KEY = '6f38e3cf13384ab8a27a8e68a4232fe1'   //和风天气中应用的key名称
const USER_ID = 'HE2105312217471749' //和风天气中应用的密钥ID

const WECHAT_APPID = 'wx47a5a57e848bdc29'
const WECHAT_APP_SECRET = '4f150641076bceaaa22f347a1f1a2244'
const $ = {
  getWechatAppConfig: () => {
    return {
      id: WECHAT_APPID,
